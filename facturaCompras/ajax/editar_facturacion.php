...
<?php
    ...
    $monto5=0;
    $monto0=0;
	$sql=mysqli_query($con, "select * from productos, compra, detalle_compra where compra.numero_factura=detalle_compra.numero_factura and compra.id_factura='$id_factura' and productos.id_producto=detalle_compra.id_producto");
	while ($row=mysqli_fetch_array($sql))
	{
	$id_detalle=$row["id_detalle"];
...
<tr>
	...
	<td class='text-right'><?php echo number_format($monto_bk,2);?></td>
	<td></td>
</tr>
