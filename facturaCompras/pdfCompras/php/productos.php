...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE ORDENES DE COMPRA', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
...
$res = "SELECT * FROM compra,proveedores WHERE fecha_factura BETWEEN '$desde' AND '$hasta' and nombre_cliente LIKE '%$dato%' and compra.id_cliente=proveedores.id_cliente";
...
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(30, 8, $productos2['numero_factura'], 0);
...
$pdf->Output('reporteCompras.pdf','D');
