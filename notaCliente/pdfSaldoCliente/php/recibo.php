...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(70, 8,'LISTADO DE NC CLIENTE', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
...
$res = "SELECT * FROM detalle_nc WHERE saldo_cliente BETWEEN '$desde' AND '$hasta' ORDER BY id_factura DESC";
...
while($productos2 = mysqli_fetch_array($productos)){
	$codigo=$productos2['id_producto'];
        //$saldo=$registro2['cantidad'];
		 $res_factura = "SELECT * FROM venta,cliente WHERE numero_factura=$codigo and venta.id_cliente=cliente.id_cliente";
	...
	$pdf->Cell(20, 8, $telefono_cliente, 0);
	$pdf->Cell(20, 8, '001'.'-'.'001'.'-'.$productos2['id_producto'], 0);
