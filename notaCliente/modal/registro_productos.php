		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="precio" name="precio" placeholder="Precio de venta del producto" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="9">
				</div>
			  </div>
			  <div class="form-group">
				<label for="estado" class="col-sm-3 control-label">Impuesto</label>
				<div class="col-sm-8">
				 <select class="form-control" id="iva" name="iva" required>
					<option value="">-- Selecciona estado --</option>
					<option value="1" selected>IVA 10%</option>
