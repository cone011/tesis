...
<?php
    ...
    $monto0=0;
    $total=0;
	$sql=mysqli_query($con, "select * from cuentacliente,tmp,cliente where cuentacliente.numero_factura=tmp.id_producto and cuentacliente.id_cliente=cliente.id_cliente and tmp.session_id='".$session_id."'");
