  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php } ?>
        ...
        <li class="<?php echo $active_cierre;?>"><a href="http://localhost/tesis/facturaFuncion/productos.php"><i class='glyphicon glyphicon-copyright-mark'></i> Cierre Turno <span class="sr-only">(current)</span></a></li>
       </ul>
