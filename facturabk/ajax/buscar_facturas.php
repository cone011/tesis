<?php
	...
	if (isset($_GET['id'])){
       ...
       while ($row=mysqli_fetch_array($sql))
	   {
        ...
        $sql_anulado="UPDATE compra SET id_cliente='".$id_clien."', condiciones='".$condiciones."', estado_factura='".$estado_factura."', accion='".$accion."' WHERE numero_factura='".$numero_factura."'";
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
		$sWhere.= " and  (proveedores.nombre_cliente like '%$q%' or compra.numero_factura like '%$q%')";
			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td class="text-right"> 
						...
						<?php if($estado_factura==1 || $estado_factura==2){ ?>
