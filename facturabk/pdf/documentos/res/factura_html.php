     ...
     <?php 
       if($verificador_factura==1){
          ...
          //Insert en la tabla detalle_cotizacion
           ...
           $insert_detail=mysqli_query($con, "INSERT INTO detalle_compra VALUES ('','$numero_factura','$id_producto','$cantidad','$precio_venta_r','$acciondetalle')");
...
?>
        ...
        <tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">TOTAL IVA (<?php //echo $impuesto; ?>)% <?php echo $simbolo_moneda;?> </td>
...
if($verificador_factura==1){
  ...
  if ($condiciones==2){
    ...
    //echo "$fecha_vencimiento";
     $insert=mysqli_query($con,"INSERT INTO compra VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$accion')");
     ...
     $insert=mysqli_query($con,"INSERT INTO cuentaproveedor VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$fecha_vencimiento')");
  }else{
    $insert=mysqli_query($con,"INSERT INTO compra VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$accion')");
   $insert_audi=mysqli_query($con,"INSERT INTO audicompra VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$fechaudi','$quien','$pcname','$accion')");
  }
