  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="<?php echo $active_facturas;?>"><a href="facturas.php"><i class='glyphicon glyphicon-list-alt'></i> N.C. de Compras <span class="sr-only">(current)</span></a></li>
       ...
       <?php if($gestion==1){ ?>   
        <li class="dropdown">  
          ...
          <ul class="dropdown-menu">
            <li class="<?php echo $active_productos;?>"><a href="http://localhost/tesis/facturaVentas/productos.php"><i class='glyphicon glyphicon-copyright-mark'></i> Productos</a></li>
      ...
      <?php } ?>
        ...
        <li class="<?php echo $active_facturas;?>"><a href="http://localhost/tesis/facturaVentas/facturas.php"><i class='glyphicon glyphicon-list-alt'></i> Facturacion <span class="sr-only">(current)</span></a></li>
