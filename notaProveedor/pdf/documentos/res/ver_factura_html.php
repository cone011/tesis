...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:50%;" class='midnight-blue'>DETALLE DE LA N.C. COMPRA</td>
        </tr>
		<tr>
           <td style="width:50%;" >
			<?php 
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            <th style="width: 10%;text-align:center" class='midnight-blue'>NUMERO O.C.</th>
            <th style="width: 60%" class='midnight-blue'>PROVEEDOR</th>
            <th style="width: 15%;text-align: right" class='midnight-blue'>MONTO N.C.</th>
            <th style="width: 15%;text-align: right" class='midnight-blue'>SALDO RESTANTE</th>
...
while ($row=mysqli_fetch_array($sql))
    ...
    $sql_producto=mysqli_query($con, "select * from proveedores where id_clente='$codigo_cliente'");
...
;
	...
	?>
        ...
        <tr>
            <td class='<?php echo $clase;?>' style="width: 10%; text-align: center"><?php echo $id_producto; ?></td>
            <td class='<?php echo $clase;?>' style="width: 60%; text-align: left"><?php echo $nombre;?></td>
            <td class='<?php echo $clase;?>' style="width: 15%; text-align: right"><?php echo $monto_nc;?></td>
            <td class='<?php echo $clase;?>' style="width: 15%; text-align: right"><?php echo $saldo_restante;?></td>
