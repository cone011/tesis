...
if (!empty($id) and !empty($cantidad) and !empty($precio_venta) and $cantidad>0 and $precio_venta>0 and ($cantidad<=$precio_venta))
{
...
<tr>
	...
	<th>Saldo Factura</th>
	<th class='text-right'>Monto Cobranza</th>
...
<?php
	...
	$total+=$cantidadtmp;
		...
		<tr>
			...
			<td class='text-right'><?php echo $monto_saldo;?></td>
