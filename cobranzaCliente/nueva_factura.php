...
while ($r=$query->fetch_array()){
	...
	$title="Nueva Cobranza | Estacion E.M.R.";
  ...
  <body OnLoad="NoBack();">
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nueva Cobranza</h4>
		</div>
			...
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Nombre</label>
					...
					<label for="factura" class="col-md-1 control-label">Numero Cobranza:</label>		
							<div class="col-md-1">
								<?php   
										$sql_factura=mysqli_query($con,"select max(numero_factura) as last from cobranza");
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="submit" class="btn btn-default">
						  <span class="glyphicon glyphicon-print"></span> Guardar Cobranza
						</button>
					</div>	
				</div>
			</form>	
