       ...
       if($verificador_factura==1){
          ...
          if($diferencia==0){
           ...
           $query_update = mysqli_query($con,$sql_cuenta);
            ...
            $insert=mysqli_query($con,"INSERT INTO saldo_cliente VALUES (NULL,'$numero_factura','$cantidadtmp','$diferencia','$cliente','$date','$fechapro','$pago','$efectivo','$tarjeta','$cheque','$transferencia')");
          ...
          /*$sqlproducto="UPDATE productos SET cantidad_producto='".$totalcantidad."' WHERE id_producto='".$id_producto."'";
           ...
           $insert_detail=mysqli_query($con, "INSERT INTO detalle_cobranza VALUES ('','$cobranza','$numero_factura','$cantidadtmp','$diferencia','$fecha')");
          $insert_audidetail=mysqli_query($con, "INSERT INTO audidetalle_cobranza VALUES ('','$cobranza','$numero_factura','$cantidadtmp','$diferencia','$accion')");  
          ...
          $insert_nc=mysqli_query($con,"INSERT INTO cobranza VALUES (NULL,'$cobranza','$date','$id_cliente','$id_vendedor','$condiciones','$precioUnitario','$condiciones','$accion','$fecha','$diferencia','$pago','$numero_factura','$efectivo','$tarjeta','$cheque','$transferencia','$cantidadtmp')");

          $insert_audi=mysqli_query($con,"INSERT INTO audicobranza VALUES (NULL,'$cobranza','$date','$id_cliente','$id_vendedor','$condiciones','$diferencia','$condiciones','$fechaudi','$quien','$pcname','$accion')");
