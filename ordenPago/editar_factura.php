...
while ($r=$query->fetch_array()){
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="proveedores.id_cliente, proveedores.nombre_cliente, proveedores.telefono_cliente, proveedores.ruc_cliente, op.id_vendedor, op.fecha_factura, op.condiciones, op.estado_factura, op.numero_factura,op.tipo_pago,op.efectivo,op.tarjeta,op.cheque,op.transferencia,cliente.email_cliente";
		$sql_factura=mysqli_query($con,"select $campos from op, proveedores where op.id_cliente=proveedores.id_cliente and id_factura='".$id_factura."'");
