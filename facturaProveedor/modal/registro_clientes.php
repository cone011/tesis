		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  <div class="form-group">
				<label for="nombre" class="col-sm-3 control-label">Nombre de Proveedor</label>
				<div class="col-sm-5">
			  ...
			  <div class="form-group">
				<label for="email" class="col-sm-3 control-label">Email del Proveedor</label>
				<div class="col-sm-5">
			 ...
			 <div class="form-group">
				<label for="Ruc" class="col-sm-3 control-label">Ruc del Proveedor</label>
				<div class="col-sm-8">
