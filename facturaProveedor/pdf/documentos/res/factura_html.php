...
if($verificador_factura==1){
   $messages[] = "Uno de los Productos Tiene existencia CERO VERIFCAR CON LA ADMINISTRACION.";
    ...
    //echo "$fecha_vencimiento";
     $insert=mysqli_query($con,"INSERT INTO venta VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$acc','$fecha')");
     ...
     $insert=mysqli_query($con,"INSERT INTO cuentacliente VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$fecha_vencimiento')");
   }else{
    $insert=mysqli_query($con,"INSERT INTO venta VALUES (NULL,'$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$condiciones','$acc','$fecha')");
