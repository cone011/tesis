...
$res = "SELECT * FROM cuentacliente,ncliente,detalle_nc WHERE fecha BETWEEN '$desde' AND '$hasta' and ncliente.numero_factura=detalle_nc.numero_factura and cuentacliente.numero_factura=ncliente.id_producto ORDER BY fecha DESC";
