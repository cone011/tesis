...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php } ?>
        <li class="<?php echo $active_facturas;?>"><a href="http://localhost/tesis/facturaCompras/facturas.php"><i class='glyphicon glyphicon-list-alt'></i> Ordenes de Compra <span class="sr-only">(current)</span></a></li>
