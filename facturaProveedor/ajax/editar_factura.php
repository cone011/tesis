<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$estado_factura=intval($_POST['estado_factura']);
		$sql="UPDATE venta SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', condiciones='".$condiciones."', estado_factura='".$estado."', total_venta='".$total."' WHERE id_factura='".$id_factura."'";
