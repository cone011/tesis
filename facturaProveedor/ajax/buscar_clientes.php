<?php
	...
	if (isset($_GET['id'])){
        ...
        $estado=0;
		if ($count==0){
			if ($delete1=mysqli_query($con,"UPDATE proveedores SET status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'")){
			?>
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($status_cliente==1){$text_estado="Activo";$label_class='label-success';}
						elseif($status_cliente==0){$text_estado="Inactivo";$label_class='label-danger';}
