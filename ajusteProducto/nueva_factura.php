...
while ($r=$query->fetch_array()){
	...
	$title="Nuevo Ajuste | Estacion E.M.R.";
  ...
  <body OnLoad="NoBack();">
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nuevo Ajuste</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  <label for="nombre_cliente" class="col-md-1 control-label">Motivo: </label>
				  <div class="col-md-2">
					...
					<label for="factura" class="col-md-1 control-label">Nro de Ajuste: </label>		
							<div class="col-md-2">
								<?php   
										$sql_factura=mysqli_query($con,"select max(numero_factura) as last from ajuste");
					...
					<label for="pago" class="col-md-3 control-label">Nro de Respaldo: </label>		
							<div class="col-md-2">
											<input type="text" class="form-control input-sm" id="pago" placeholder="Nro Respaldo">
							</div>		
						...
						<div class="form-group row">
							...
							<label for="email" class="col-md-1 control-label">Tipo de Ajuste: </label>
							<div class="col-md-2">
								<select class='form-control input-sm' id="condiciones">
									<option value="1">AJUSTE MAS</option>
									<option value="2">AJUSTE MENOS</option>
								</select>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="pull-right">
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoCliente">
						 <span class="glyphicon glyphicon-list-alt"></span> Nuevo Motivo
						</button>
