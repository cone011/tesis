...
while ($r=$query->fetch_array()){
	...
	$active_bk="";
	$title="Ajustes de Productos | E.M.R.";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<a  href="nueva_factura.php" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span> Nueva Ajuste</a>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Ajuste</h4>
		</div>
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="datos_cotizacion">
				
						<div class="form-group row">
							<label for="q" class="col-md-2 control-label">Motivo o # de Ajuste</label>
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Motivo del Ajuste o # de Ajuste" onkeyup='load(1);'>
							</div>
