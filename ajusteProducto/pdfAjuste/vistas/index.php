...
<body>
    ...
    <header>Reporte de Ajuste Producto PDF</header>
    <section>
  <div class="table-responsive">      
    <table border="0" align="center">
    	<tr>
            ...
            <td width="100"><a href="http://localhost/tesis/ajusteProducto/facturas.php" class="btn btn-primary">Volver Menu</a></td>
        </tr>
    </table>
    </section>
