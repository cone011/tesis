<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="motivoajuste.id_cliente, motivoajuste.nombre_cliente, motivoajuste.telefono_cliente, motivoajuste.ruc_cliente, ajuste.id_vendedor, ajuste.fecha_factura, ajuste.condiciones, ajuste.estado_factura, ajuste.numero_factura";
		$sql_factura=mysqli_query($con,"select $campos from ajuste, motivoajuste where ajuste.id_cliente=ajuste.id_cliente and id_factura='".$id_factura."'");
				...
				<div class="form-group row">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
				    ...
				    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoCliente">
						 <span class="glyphicon glyphicon-list-alt"></span> Relacion de Factura
						</button>
