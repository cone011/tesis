...
if(isset($_POST['generar_reporte']))
{
	...
	// ENCABEZADOS
	fputcsv($salida, array('Numero de Documento', 'Timbrado', 'Codigo Producto', 'Nombre Producto', 'Codigo Cliente', 'Nombre Cliente','Ruc', 'Precio', 'Iva 10%', 'Iva 05%','Excento','Fecha Facturacion'));
