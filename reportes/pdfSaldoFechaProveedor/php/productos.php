...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE SALDO PROVEEDORES', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
...
$pdf->Cell(20, 8, 'Saldo Existente', 0);
$pdf->Cell(30, 8, 'Fech. Registro', 0);
$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
//CONSULTA

$res = "SELECT * FROM compra,proveedores WHERE fecha_factura BETWEEN '$desde' AND '$hasta' and nombre_cliente LIKE '%$dato%' and estado_factura=2 and compra.id_cliente=proveedores.id_cliente order by numero_factura desc";
...
while($productos2 = mysqli_fetch_array($productos)){
   ...
   if(strlen($productos2["pf2"])==1){
	...
	$pdf->Cell(30, 8, $wpf1.$productos2['pf1'].'-'.'001'.'-'.$productos2['numero_factura'], 0);
...
$pdf->Output('reporteProveedoreSaldo.pdf','D');
