...
$res = "SELECT * FROM venta,cliente WHERE fecha_factura BETWEEN '$desde' AND '$hasta' and estado_factura=2 and cliente.id_cliente=venta.id_cliente ORDER BY fecha_factura DESC";
