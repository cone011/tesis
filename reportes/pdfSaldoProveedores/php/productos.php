...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'SALDO DE PROVEEDORES', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
$pdf->Ln(23);
...
$res = "SELECT * FROM proveedores where id_cliente<>999";
...
while($productos2 = mysqli_fetch_array($productos)){
	...
	$item = $item+1;
	$totaluni = 0;
	$res_producto = "SELECT * FROM compra WHERE id_cliente='$id_cliente' and compra.estado_factura=2";
...
$pdf->Output('reportesSaldoProveed.pdf','D');
