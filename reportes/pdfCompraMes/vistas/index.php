...
<body>
    <?php include "navbar.php"; 
        $mes=date("m");
    ?>
    <header>Reporte de Compra Mes PDF</header>
    <section>
  <div class="table-responsive">      
    <table border="0" align="center">
    	<tr>

            <td width="335"><input type="hidden" placeholder="Busca un producto por: Nombre o Tipo" id="bs-prod"/></td>
            <td><input type="hidden" id="bd-desde" value="<?php echo $mes;?>" /></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td width="400"><a target="_blank" href="javascript:reportePDF();" class="btn btn-danger">Exportar a PDF</a></td>
            <td width="100"><a href="http://localhost/tesis/facturaVentas/facturas.php" class="btn btn-primary">Volver Menu</a></td>
            <td><input type="hidden" id="bd-hasta" value="<?php echo $mes; ?>" /></td>
