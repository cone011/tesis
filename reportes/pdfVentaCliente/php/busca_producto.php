...
$res = "SELECT * FROM cliente,venta WHERE (nombre_cliente LIKE '%$dato%' OR telefono_cliente LIKE '%$dato%') and cliente.id_cliente=venta.id_cliente ORDER BY fecha_factura DESC";
