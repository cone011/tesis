...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE CUENTA PROVEEDOR', 0);
$pdf->Ln(10);
$pdf->Cell(65, 8, '', 0);
...
$res = "SELECT * FROM detalle_cuenta_proveedor,proveedores WHERE FECHA BETWEEN '$desde' AND '$hasta' and nombre_cliente LIKE '%$dato%' and detalle_cuenta_proveedor.ID_PROVEEDOR=proveedores.id_cliente";
...
while($productos2 = mysqli_fetch_array($productos)){
	...
	$pdf->Cell(20, 8, $productos2['NRO_COMPRA'], 0);
	$pdf->Cell(20, 8, $productos2['NRO_OP'], 0);
