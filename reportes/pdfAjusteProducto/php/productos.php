...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE AJUSTE PRODUCTO', 0);
$pdf->Ln(10);
$pdf->Cell(65, 8, '', 0);
$pdf->Cell(100, 8, 'Desde: '.$verDesde.' hasta: '.$verHasta, 0);
$pdf->Ln(10);
$pdf->Cell(80, 8, '', 0);
$pdf->Cell(10, 8, 'Prodct.: '.$dato, 0);
$pdf->Ln(23);
...
$res = "SELECT * FROM detalle_ajuste,productos WHERE fecha BETWEEN '$desde' AND '$hasta' and nombre_producto LIKE '%$dato%' and detalle_ajuste.id_producto=productos.id_producto order by numero_factura desc";
...
$pdf->Output('reporteAjusteXproducto.pdf','D');
