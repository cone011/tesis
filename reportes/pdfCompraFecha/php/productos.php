...
$pdf->Cell(67, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE COMPRAS x FECHA', 0);
$pdf->Ln(10);
$pdf->Cell(65, 8, '', 0);
...
$res = "SELECT * FROM compra,proveedores WHERE fecha_factura BETWEEN '$desde' AND '$hasta' and compra.id_cliente=proveedores.id_cliente order by numero_factura desc";
...
$pdf->Output('reporteCompraXfecha.pdf','D');
