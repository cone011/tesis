...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(70, 8,'LISTADO VENTAS MES', 0);
$pdf->Ln(10);
$pdf->Cell(75, 8, '', 0);
...
//CONSULTA
$mes=date("m");
$res = "SELECT * FROM cliente,venta WHERE month(fecha)='$mes' and venta.id_cliente=cliente.id_cliente order by numero_factura desc";
...
$pdf->Output('reporteVentaMes.pdf','D');
