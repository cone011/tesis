...
$alumnos="SELECT * FROM compra,proveedores where year(fecha_factura) = 2018 and compra.id_cliente=proveedores.id_cliente order by numero_factura DESC";
$resAlumnos=$conexion->query($alumnos);
?>

<html lang="es">
	<head>
		<title>Excel de Compras Realizadas</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<header>
			...
			<h2>Excel de Compras Realizadas</h2>
			</div>
		</header>
		<section>
