...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'LISTADO DE VENTAS x FECHA', 0);
$pdf->Ln(10);
$pdf->Cell(65, 8, '', 0);
...
$res = "SELECT * FROM venta,cliente WHERE fecha_factura BETWEEN '$desde' AND '$hasta'  and venta.id_cliente=cliente.id_cliente order by numero_factura desc";
...
$pdf->Output('reporteVentaXfecha.pdf','D');
